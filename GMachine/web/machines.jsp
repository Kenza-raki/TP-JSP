<%-- 
    Document   : machines
    Created on : Oct 24, 2023, 5:10:15 PM
    Author     : HP
--%>
        ...
        <form action="MachineController" method="GET">
            <fieldset>
                ...
                <table border="0">
                        ...
                        <tr>
                            <td>Matque : </td>
                            <td><input type="text" name="matque" value="" /></td>
                        </tr>
                        <tr>
                            <td>Prix :</td>
            ...
            <legend>Liste des machines</legend>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><%= m.getMatque()%></td>
                        <td><%= m.getPrix()%></td>
                        <td><a href="MachineController?op=delete&id=<%= m.getId()%>">Ajouter</a></td>
                        <td><a href="MachineController">Supprimer</a></td>
                    </tr>
                    <% }%>
                </tbody>
            </table>
